...
class objectManager():
    def saver(self, model, models_folder,shown_params = False, model_performance_metrics=None,detailed_params=None):
        """
        ...
        if model_performance_metrics != None:
            performance_metrics = open(models_folder+"/performance_metrics.txt","a+")
