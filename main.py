...
def run(train_json, test_json, embeddings, experiment_output_folder, epochs, num_random_search, max_size, device, GS,
...
if __name__ == "__main__":
    ...
    run(args.train_json, args.test_json, args.embeddings, args.experiment_output_folder, args.epochs,
